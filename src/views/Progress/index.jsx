    ...
    if(status=="All status"){
      if(center=="All centers"){
        if(field=="Filter By Id/Object..."){
          try {
            const response = await fetch("http://springboot-service.default.svc.cluster.local:8080/document/getAllTyped/pageNumber="+pageNumber+"&pageSize=15?inbound="+inbound,{method:"GET",headers:{
          ...
          try {
            const response = await fetch("http://springboot-service.default.svc.cluster.local:8080/document/getTyped/id="+field+"?inbound="+inbound,{method:"GET",headers:{
              'Authorization': `Bearer ${token}`
            }});
              if (!response.ok) {
                throw new Error('Failed to fetch data');
          ...
          try {
            const response = await fetch("http://springboot-service.default.svc.cluster.local:8080/document/getTyped/GW_ID="+field+"?inbound="+inbound+"&pageNumber="+pageNumber,{method:"GET",headers:{
              'Authorization': `Bearer ${token}`
            }});
              if (!response.ok) {
                throw new Error('Failed to fetch data');
        ...
        if(field=="Filter By Id/Object..."){
          try {
            const response = await fetch("http://springboot-service.default.svc.cluster.local:8080/document/getTyped/service="+center+"?inbound="+inbound+"&pageNumber="+pageNumber,{method:"GET",headers:{
              'Authorization': `Bearer ${token}`
            }});
              if (!response.ok) {
                throw new Error('Failed to fetch data');
          ...
          try {
            const response = await fetch("http://springboot-service.default.svc.cluster.local:8080/document/getTyped/service="+center+"/Gw_ID="+field+"?inbound="+inbound+"&pageNumber="+pageNumber,{method:"GET",headers:{
              'Authorization': `Bearer ${token}`
            }});
              if (!response.ok) {
                throw new Error('Failed to fetch data');
      ...
      if(center=="All centers"){
        if(field=="Filter By Id/Object..."){
          try {
            const response = await fetch("http://springboot-service.default.svc.cluster.local:8080/document/getTyped/status="+status+"?inbound="+inbound+"&pageNumber="+pageNumber,{method:"GET",headers:{
              'Authorization': `Bearer ${token}`
            }});
              if (!response.ok) {
                throw new Error('Failed to fetch data');
          ...
          try {
            const response = await fetch("http://springboot-service.default.svc.cluster.local:8080/document/getTyped/status="+status+"/Gw_ID="+field+"?inbound="+inbound+"&pageNumber="+pageNumber,{method:"GET",headers:{
              'Authorization': `Bearer ${token}`
            }});
              if (!response.ok) {
                throw new Error('Failed to fetch data');
        ...
        if(field=="Filter By Id/Object..."){
          try {
            const response = await fetch("http://springboot-service.default.svc.cluster.local:8080/document/getTyped/status="+status+"/service="+center+"?inbound="+inbound+"&pageNumber="+pageNumber,{method:"GET",headers:{
              'Authorization': `Bearer ${token}`
            }});
              if (!response.ok) {
                throw new Error('Failed to fetch data');
          ...
          try {
            const response = await fetch("http://springboot-service.default.svc.cluster.local:8080/document/getTyped/status="+status+"/service="+center+"/Gw_ID="+field+"?inbound="+inbound+"&pageNumber="+pageNumber,{method:"GET",headers:{
              'Authorization': `Bearer ${token}`
            }});
              if (!response.ok) {
                throw new Error('Failed to fetch data');
