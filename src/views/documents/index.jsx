...
//Pie chart Data
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const response = await fetch("http://springboot-service.default.svc.cluster.local:8080/document/get/Numbers/start="+startIso+"&end="+endIso,{method:"GET",headers:{
    ...
    if(status=="All status"){
      if(center=="All centers"){
        if(field=="Filter By Id/Object..."){
          try {
            const response = await fetch("http://springboot-service.default.svc.cluster.local:8080/document/getAll/pageNumber="+pageNumber+"&pageSize=10",{method:"GET",headers:{
              'Authorization': `Bearer ${token}`
            }});
              if (!response.ok) {
                throw new Error('Failed to fetch data');
          ...
          try {
            const response = await fetch("http://springboot-service.default.svc.cluster.local:8080/document/get/id="+field,{method:"GET",headers:{
              'Authorization': `Bearer ${token}`
            }});
              if (!response.ok) {
                throw new Error('Failed to fetch data');
          ...
          try {
            const response = await fetch("http://springboot-service.default.svc.cluster.local:8080/document/get/GW_ID="+field+"?pageNumber="+pageNumber,{method:"GET",headers:{
              'Authorization': `Bearer ${token}`
            }});
              if (!response.ok) {
                throw new Error('Failed to fetch data');
        ...
        if(field=="Filter By Id/Object..."){
          try {
            const response = await fetch("http://springboot-service.default.svc.cluster.local:8080/document/get/service="+center+"?pageNumber="+pageNumber,{method:"GET",headers:{
              'Authorization': `Bearer ${token}`
            }});
              if (!response.ok) {
                throw new Error('Failed to fetch data');
          ...
          try {
            const response = await fetch("http://springboot-service.default.svc.cluster.local:8080/document/get/service="+center+"/Gw_ID="+field+"?pageNumber="+pageNumber,{method:"GET",headers:{
              'Authorization': `Bearer ${token}`
            }});
              if (!response.ok) {
                throw new Error('Failed to fetch data');
      ...
      if(center=="All centers"){
        if(field=="Filter By Id/Object..."){
          try {
            const response = await fetch("http://springboot-service.default.svc.cluster.local:8080/document/get/status="+status+"?pageNumber="+pageNumber,{method:"GET",headers:{
              'Authorization': `Bearer ${token}`
            }});
              if (!response.ok) {
                throw new Error('Failed to fetch data');
          ...
          try {
            const response = await fetch("http://springboot-service.default.svc.cluster.local:8080/document/get/GW_ID="+field,{method:"GET",headers:{
              'Authorization': `Bearer ${token}`
            }});
              if (!response.ok) {
                throw new Error('Failed to fetch data');
          ...
          try {
            const response = await fetch("http://springboot-service.default.svc.cluster.local:8080/document/get/status="+status+"/Gw_ID="+field+"?pageNumber="+pageNumber,{method:"GET",headers:{
              'Authorization': `Bearer ${token}`
            }});
              if (!response.ok) {
                throw new Error('Failed to fetch data');
        ...
        if(field=="Filter By Id/Object..."){
          try {
            const response = await fetch("http://springboot-service.default.svc.cluster.local:8080/document/get/status="+status+"/service="+center+"?pageNumber="+pageNumber,{method:"GET",headers:{
              'Authorization': `Bearer ${token}`
            }});
              if (!response.ok) {
                throw new Error('Failed to fetch data');
          ...
          try {
            const response = await fetch("http://springboot-service.default.svc.cluster.local:8080/document/get/status="+status+"/service="+center+"/Gw_ID="+field+"?pageNumber="+pageNumber,{method:"GET",headers:{
              'Authorization': `Bearer ${token}`
            }});
              if (!response.ok) {
                throw new Error('Failed to fetch data');
  ...
  async function messageQueuesStatus(){
    const docProdReqResponse = await fetch("http://springboot-service.default.svc.cluster.local:8080/messagesqueues/getDocProdStatus",{method:"GET",headers:{
      'Authorization': `Bearer ${token}`
    }});
    ...
    const rmsResponse = await fetch("http://springboot-service.default.svc.cluster.local:8080/messagesqueues/getRmsStatus",{method:"GET",headers:{
      'Authorization': `Bearer ${token}`
    }});
    ...
    const eSigntureResponse = await fetch("http://springboot-service.default.svc.cluster.local:8080/messagesqueues/getEsignatureStatus",{method:"GET",headers:{
      'Authorization': `Bearer ${token}`
    }});
